...
class EmailVerificationSentPage extends StatefulWidget {final String email;
const EmailVerificationSentPage({super.key, required this.email});

@override
State<EmailVerificationSentPage> createState() => _EmailVerificationSentPageState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Click the link in the email to verify your account.\nAfter clicking, you will be redirected to the login page.", textAlign: TextAlign.center, style: TextStyle(color: Colors.white54, fontSize: 12)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isResending ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text("Resend Email", style: TextStyle(fontSize: 16)),
              ),
            ),
